...
public final class AccelerometerPersistingObserver extends MetaWearAsyncSensorPersistingObserver {

    public AccelerometerPersistingObserver(Context context) {
        super(context);
    }
